...
#### For Android Project
```groovy
apply from: 'https://raw.github.com/itlgl/gradle-mvn-push/v1.0.3/gradle-mvn-push-android.gradle'
```

#### For JAVA Project
```groovy
apply from: 'https://raw.github.com/itlgl/gradle-mvn-push/v1.0.3/gradle-mvn-push-java.gradle'
```
